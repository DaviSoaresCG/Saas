        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('products.update',['product' => $product->id]) }}"
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <button type="submit"
                        class="col-span-2 items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium justify-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                        Editar
                    </button>
            </form>
        </div>
