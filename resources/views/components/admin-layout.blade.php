            ...
            <div class="min-w-0 flex-1">
                @if ($showBackBar)
                    <div class="mb-6 flex flex-wrap items-center gap-2">
                        <button type="button"
                            onclick="(function(){var d='{{ route('dashboard') }}';try{var r=document.referrer;if(r&&new URL(r).hostname===location.hostname){history.back();return;}}catch(e){}window.location.href=d;})();"
