        ...
        <div class="flex items-center justify-between h-20">
          <div class="flex items-center">
            <div class="flex-shrink-0 flex items-center gap-2 cursor-pointer">
              ...
              <span class="text-white font-bold text-xl tracking-tight">ZapCatalog</span>
            </div>
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6 space-x-4">
              <button class="text-gray-300 hover:text-white font-medium text-sm">
                Login
              </button>
              <button class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-all shadow-lg shadow-blue-600/20 hover:scale-105">
                Criar Loja Grátis
              </button>
            </div>
          </div>
      ...
      <div id="mobile-menu" class="hidden md:hidden bg-slate-900 border-b border-slate-800 transition-all duration-300 ease-in-out">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div class="pt-4 border-t border-slate-800 mt-4">
            ...
            <button class="mt-2 block w-full bg-blue-600 text-white px-3 py-3 rounded-md text-base font-medium text-center">
              Criar Loja Grátis
            </button>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              <button class="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-bold rounded-xl text-white bg-blue-600 hover:bg-blue-700 md:text-lg transition-all shadow-lg shadow-blue-600/30 hover:scale-105">
                Começar Agora Grátis
                <i data-lucide="arrow-right" class="ml-2 h-5 w-5"></i>
              </button>
              <button class="inline-flex items-center justify-center px-8 py-4 border border-slate-700 text-base font-bold rounded-xl text-gray-300 bg-slate-800/50 hover:bg-slate-800 md:text-lg transition-all hover:text-white">
                Ver Demonstração
              </button>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 hover:bg-slate-800 transition-colors duration-300">
              <div class="inline-flex items-center justify-center p-3 bg-blue-600/20 rounded-xl mb-6">
            ...
            <div class="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 hover:bg-slate-800 transition-colors duration-300">
              ...
              <p class="text-gray-400 leading-relaxed">
                Cadastre fotos, descrições, variações (tamanho/cor) e preços de forma ilimitada e simples.
              </p>
            </div>
            <!-- Feature 4 -->
            <div class="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 hover:bg-slate-800 transition-colors duration-300">
            ...
            <div class="flex flex-col p-8 rounded-2xl border bg-slate-800/40 border-slate-700">
              ...
              <ul class="space-y-4 mb-8 flex-1">
                ...
                <li class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-300">1 Usuário administrador</span>
                </li>
                 <li class="flex items-start">
                  <div class="flex-shrink-0 h-5 w-5 rounded-full flex items-center justify-center mt-0.5 bg-green-500/20">
                    <i data-lucide="check" class="h-3 w-3 text-green-500"></i>
            ...
            <div class="flex flex-col p-8 rounded-2xl border bg-slate-800/80 border-blue-500 shadow-xl shadow-blue-900/20 relative overflow-hidden transform md:-translate-y-4">
              ...
              <ul class="space-y-4 mb-8 flex-1">
                ...
                <li class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-300">Até 5 Usuários</span>
                </li>
                 <li class="flex items-start">
                  <div class="flex-shrink-0 h-5 w-5 rounded-full flex items-center justify-center mt-0.5 bg-green-500/20">
                    <i data-lucide="check" class="h-3 w-3 text-green-500"></i>
                ...
                <li class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-300">Gestão de estoque</span>
                </li>
              </ul>
            ...
            <div class="flex flex-col p-8 rounded-2xl border bg-slate-800/40 border-slate-700">
              ...
              <ul class="space-y-4 mb-8 flex-1">
                ...
                <li class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-300">Usuários Ilimitados</span>
                </li>
                 <li class="flex items-start">
                  <div class="flex-shrink-0 h-5 w-5 rounded-full flex items-center justify-center mt-0.5 bg-green-500/20">
                    <i data-lucide="check" class="h-3 w-3 text-green-500"></i>
                ...
                <li class="flex items-start">
                  ...
                  <span class="ml-3 text-sm text-gray-300">API de integração</span>
                </li>
              </ul>
